...
foray_movements <- amwo_data_reconstructed %>% 
  ...
  mutate(date_standardized = ymd(paste0("2020-", month(time), "-", day(time)))) #%>% 
  #mutate(animal_name = if_else(animal_name == "ME-2018-08", if_else(year(time) == 2019, "RI-2019-29-2019", "RI-2019-29-2020"), animal_name))
...
ggsave(filename = here::here("auxiliary_state_plot", "auxiliary_state_plot_4.png"), plot = plots_arranged, dpi = 300, bg = "white", height = 7, width = 7)
```
