...
dispersal_map <- template_map +
  geom_sf(data = dispersal_line, linewidth = 0.5, colour = c("#F0A0FF", "#4C005C", "#0075DC", "#C20088")) +
...
dispersal_timeline <- ggplot(data = dispersal_summary, mapping = aes(x = value, y = animal_name, group = animal_name, color = animal_name)) +
  ...
  scale_color_manual(values = c("#F0A0FF", "#4C005C", "#0075DC", "#C20088")) +
  ggtitle("Dispersal movement")
...
summer_map <- template_map +
  geom_sf(data = summer_line, linewidth = 0.5, colour = c("#4C005C", "#0075DC", "#993F00")) + 
...
summer_timeline <- ggplot(data = summer_summary, mapping = aes(x = value, y = animal_name, group = animal_name, color = animal_name)) +
  ...
  theme(axis.title.y = element_blank(),
        ...
        axis.ticks.y=element_blank(),
        legend.position = "none") +
  scale_color_manual(values = c("#4C005C", "#0075DC", "#993F00")) +
  ggtitle("Summer migration")
```
...
ggsave(filename = here::here("auxiliary_state_plot", "auxiliary_state_plot_5_25_2023.png"), plot = plots_arranged, dpi = 300, bg = "white", height = 7.5, width = 7)
```
