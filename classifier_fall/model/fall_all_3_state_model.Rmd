...
Par0_m1 <- list(step=c(0.485, 211.927, 0.485, #mean in km
                ...
                y = c(41.58981, 36.79636, 34.32931,
                      4.433215, 4.035114, 2.398324),
                julian_day = c(231.1194, 269.1586, 313.0377, #priors pulled from the model w/o julian day
                        27.13328, 27.70735, 25.30101),
