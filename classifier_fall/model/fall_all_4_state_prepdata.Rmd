...
amwo_2017 <- getMovebankData(study = "American Woodcock Migration Ecology in Eastern North America", login = readRDS("movebank_credentials.rds"), timestamp_start = "20170801000000000", timestamp_end = "20180225000000000", removeDuplicatedTimestamps=TRUE) %>% as.data.frame() #20190115000000000

amwo_2018 <- getMovebankData(study = "American Woodcock Migration Ecology in Eastern North America", login = readRDS("movebank_credentials.rds"), timestamp_start = "20180801000000000", timestamp_end = "20190225000000000", removeDuplicatedTimestamps=TRUE) %>% as.data.frame() #20190115000000000

amwo_2019 <- getMovebankData(study = "American Woodcock Migration Ecology in Eastern North America", login = readRDS("movebank_credentials.rds"), timestamp_start = "20190801000000000", timestamp_end = "20200225000000000", removeDuplicatedTimestamps=TRUE) %>% 
  as.data.frame() #%>% 
# filter(timestamp < if_else(local_identifier == "VA-2019-48", ymd_hms("2020-3-30 00:00:00"), ymd_hms("2020-2-25 00:00:00")))

amwo_2020 <- getMovebankData(study = "American Woodcock Migration Ecology in Eastern North America", login = readRDS("movebank_credentials.rds"), timestamp_start = "20200801000000000", timestamp_end = "20210225000000000", removeDuplicatedTimestamps=TRUE) %>% as.data.frame()

amwo_2021 <- getMovebankData(study = "American Woodcock Migration Ecology in Eastern North America", login = readRDS("movebank_credentials.rds"), timestamp_start = "20210801000000000", timestamp_end = "20220225000000000", removeDuplicatedTimestamps=TRUE) %>% as.data.frame()

amwo_2022 <- getMovebankData(study = "American Woodcock Migration Ecology in Eastern North America", login = readRDS("movebank_credentials.rds"), timestamp_start = "20220801000000000", timestamp_end = "20230225000000000", removeDuplicatedTimestamps=TRUE) %>% as.data.frame()
```
...
```{r}
amwo_spring <- as.data.frame(rbind(amwo_2017, amwo_2018, amwo_2019, amwo_2020, amwo_2021, amwo_2022))
