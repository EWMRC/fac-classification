...
amwo_2022 <- getMovebankData(study = "American Woodcock Migration Ecology in Eastern North America", login = readRDS(here::here("movebank_credentials.rds")), timestamp_start = "20220801000000000", timestamp_end = "20230225000000000", removeDuplicatedTimestamps=TRUE) %>% as.data.frame()
```
