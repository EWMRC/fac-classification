...
amwo_data_reconstructed <- amwo_data_reconstructed %>% 
  mutate(primary_step_state = if_else(event_id %in% c(7570774634, 7662851838, 7662851839), "Foray loop (fall)", primary_step_state),
         primary_point_state = if_else(event_id %in% c(7662851838, 7662851839), "Foray loop (fall)", primary_point_state))
...
amwo_data_reconstructed <- amwo_data_reconstructed %>% 
  mutate(primary_step_state = if_else(event_id %in% c(20247710616, 20247710619, 20334121982, 20334121986), "Foray loop (fall)", primary_step_state),
         primary_point_state = if_else(event_id %in% c(20247710619, 20334121982, 20334121986), "Foray loop (fall)", primary_point_state))
