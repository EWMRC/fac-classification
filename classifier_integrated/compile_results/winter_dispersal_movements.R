...
amwo_data_reconstructed <- amwo_data_reconstructed %>% 
  mutate(primary_step_state = if_else(event_id == 13579628721, "Dispersal", primary_step_state))
...
amwo_data_reconstructed <- amwo_data_reconstructed %>% 
  mutate(primary_step_state = if_else(event_id %in% c(13877262855, 13877262856), "Dispersal", primary_step_state),
         primary_point_state = if_else(event_id == 13877262856, "Dispersal", primary_point_state))
