...
```{r}
source(here::here("classifier_integrated", "compile_results", "summer_dispersal_movements_base.R"))
source(here::here("classifier_integrated", "compile_results", "summer_migrations_base.R"))
source(here::here("classifier_integrated", "compile_results", "summer_foray_loops_base.R"))
source(here::here("classifier_integrated", "compile_results", "winter_foray_loops_base.R"))
source(here::here("classifier_integrated", "compile_results", "winter_dispersal_movements_base.R"))
source(here::here("classifier_integrated", "compile_results", "spring_foray_loops_base.R"))
source(here::here("classifier_integrated", "compile_results", "fall_foray_loops_base.R"))
```
