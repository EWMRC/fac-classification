...
amwo_data_reconstructed <- amwo_data_reconstructed %>% 
  mutate(primary_step_state = if_else(event_id %in% c(21279049764, 21279049767, 21279049774), "Foray loop (winter)", primary_step_state),
         primary_point_state = if_else(event_id %in% c(21279049767, 21279049774), "Foray loop (winter)", primary_point_state))
...
amwo_data_reconstructed <- amwo_data_reconstructed %>% 
  mutate(primary_step_state = if_else(event_id %in% c(8807074660, 8807074661), "Foray loop (winter)", primary_step_state),
         primary_point_state = if_else(event_id %in% c(8807074661), "Foray loop (winter)", primary_point_state))
...
amwo_data_reconstructed <- amwo_data_reconstructed %>% 
  mutate(primary_step_state = if_else(event_id %in% c(13598268172, 13598268173, 13607659369), "Foray loop (winter)", primary_step_state),
         primary_point_state = if_else(event_id %in% c(13598268173, 13607659369), "Foray loop (winter)", primary_point_state))
