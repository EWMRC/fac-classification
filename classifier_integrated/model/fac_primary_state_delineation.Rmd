...
```{r}
fall_classified <- readRDS(here::here("classifier_fall", "fall_all_3_state_model.rds"))
spring_male_classified <- readRDS(here::here("classifier_spring", "spring_male_3_state_model.rds"))
spring_female_classified <-readRDS(here::here("classifier_spring", "spring_female_3_state_model.rds"))
```
