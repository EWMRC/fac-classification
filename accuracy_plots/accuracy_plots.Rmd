...
results_fall_full <- here("classifier_fall", "accuracy", "full_acc_assessment", "accuracy_results_fall_full.csv") %>% 
  ...
  mutate(season = "Fall",
         model_type = "Full") %>% 
  filter(standardized_date < ymd("2021-1-31"))
...
dummy <- tibble(standardized_date = ymd(c("2020-10-01", "2020-10-01", "2020-03-01", "2020-03-01", "2020-03-01", "2020-03-01", "2021-02-05", "2021-02-05", "2020-07-01", "2020-07-01", "2020-07-01", "2020-07-01")), percent_error = 0, season = c("Fall", "Fall", "Spring Male", "Spring Male", "Spring Female", "Spring Female", "Fall", "Fall", "Spring Male", "Spring Male", "Spring Female", "Spring Female"), model_type = c("Full", "Reduced", "Full", "Reduced", "Full", "Reduced", "Full", "Reduced", "Full", "Reduced", "Full", "Reduced"), test = "Type I") %>% 
  bind_rows(tibble(standardized_date = ymd(c("2020-10-01", "2020-10-01", "2020-03-01", "2020-03-01", "2020-03-01", "2020-03-01", "2021-02-05", "2021-02-05", "2020-07-01", "2020-07-01", "2020-07-01", "2020-07-01")), percent_error = 0, season = c("Fall", "Fall", "Spring Male", "Spring Male", "Spring Female", "Spring Female", "Fall", "Fall", "Spring Male", "Spring Male", "Spring Female", "Spring Female"), model_type = c("Full", "Reduced", "Full", "Reduced", "Full", "Reduced", "Full", "Reduced", "Full", "Reduced", "Full", "Reduced"), test = "Type II")) %>% 
...
ggsave("accuracy_plot_7_11_23_prelim.png", width = 7, height = 5)
```
