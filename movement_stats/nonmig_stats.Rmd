...
Fall- 2017, 2018, 2019, 2020, 2021, 2022, 2023
Spring- 2018, 2019, 2020, 2021, 2022, 2023, 2024
```{r}
# fall
fall_nonmigs_2017 <- did_you_skip(season_start_date = ymd("2017-10-25"), season_end_date = ymd("2017-12-06")) %>% 
  mutate(season = "Fall", year = 2017)

fall_nonmigs_2018 <- did_you_skip(season_start_date = ymd("2018-10-25"), season_end_date = ymd("2018-12-06")) %>% 
  mutate(season = "Fall", year = 2018)

fall_nonmigs_2019 <- did_you_skip(season_start_date = ymd("2019-10-25"), season_end_date = ymd("2019-12-06")) %>% 
  mutate(season = "Fall", year = 2019)

fall_nonmigs_2020 <- did_you_skip(season_start_date = ymd("2020-10-25"), season_end_date = ymd("2020-12-06")) %>% 
  mutate(season = "Fall", year = 2020)

fall_nonmigs_2021 <- did_you_skip(season_start_date = ymd("2021-10-25"), season_end_date = ymd("2021-12-06")) %>% 
  mutate(season = "Fall", year = 2021)

fall_nonmigs_2022 <- did_you_skip(season_start_date = ymd("2022-10-25"), season_end_date = ymd("2022-12-06")) %>% 
  mutate(season = "Fall", year = 2022)

fall_nonmigs_2023 <- did_you_skip(season_start_date = ymd("2023-10-25"), season_end_date = ymd("2023-12-06")) %>% 
  mutate(season = "Fall", year = 2023)

#spring

spring_nonmigs_2018 <- did_you_skip(season_start_date = ymd("2018-2-25"), season_end_date = ymd("2018-3-29")) %>% 
  mutate(season = "Spring", year = 2018)

spring_nonmigs_2019 <- did_you_skip(season_start_date = ymd("2019-2-25"), season_end_date = ymd("2019-3-29")) %>% 
  mutate(season = "Spring", year = 2019)

spring_nonmigs_2020 <- did_you_skip(season_start_date = ymd("2020-2-25"), season_end_date = ymd("2020-3-29")) %>% 
  mutate(season = "Spring", year = 2020)

spring_nonmigs_2021 <- did_you_skip(season_start_date = ymd("2021-2-25"), season_end_date = ymd("2021-3-29")) %>% 
  mutate(season = "Spring", year = 2021)

spring_nonmigs_2022 <- did_you_skip(season_start_date = ymd("2022-2-25"), season_end_date = ymd("2022-3-29")) %>% 
  mutate(season = "Spring", year = 2022)

spring_nonmigs_2023 <- did_you_skip(season_start_date = ymd("2023-2-25"), season_end_date = ymd("2023-3-29")) %>% 
  mutate(season = "Spring", year = 2023)

spring_nonmigs_2024 <- did_you_skip(season_start_date = ymd("2024-2-25"), season_end_date = ymd("2024-3-29")) %>% 
  mutate(season = "Spring", year = 2023)
```
