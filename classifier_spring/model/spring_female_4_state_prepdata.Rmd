...
amwo_hmm <- amwo_hmm %>% #removing ranging movements
  filter(!(ID == "AL-2022-15-2022" & time == ymd_hms("2022-02-28 17:00:00"))) %>% #may need to check if some of these need to go back in...
  ...
  filter(!(ID == "ME-2018-13-2019" & julian_day == 7)) %>% 
