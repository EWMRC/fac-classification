...
dist <- list(step="gamma", angle="wrpcauchy", julian_day = "norm", dist_start = "bern", step_500 = "bern") #, y = "norm", , log_mean_dist_7 = "norm", residence_time = "norm",  , breeding_abundance = "bern"
```
...
Par0_m1 <- list(step=c(0.293641627, 79.029506936, 0.157361645, 0.250739740, 0.086056474, #mean in km
                ...
                julian_day = c(40.14297, 79.36682, 80.54528, 135.69949, 136.7710, #mean
                        19.89502, 27.50774, 23.92289, 25.77254, 30.0146),#concentration
