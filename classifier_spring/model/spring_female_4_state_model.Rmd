...
dist <- list(step="gamma", angle="wrpcauchy", y = "norm", julian_day = "norm", dist_start = "bern", step_500 = "bern", breeding_abundance = "bern", log_mean_dist_7 = "norm") #,  , log_mean_dist_7 = "norm", residence_time = "norm",  
```
...
```{r}
Par0_m1 <- list(step=c(0.256894766, 9.280669e+01, 0.301858315, 0.1020830, #mean in km
                       0.428115246, 9.998649e+01, 0.526387184, 0.1597016, # SD in km
                       0.002895599, 1.556613e-09, 0.009130244, 0.0101866), #zeromass ie how many zeroes expected in the distribution
                angle=c(0.001083468, -0.004341168, 0.002000331, -0.0005895074, #mean
                        0.882835350, 0.912545440, 0.367423909, 0.8726309448),
                y = c(34.83030, 40.173268, 40.426752,  44.689995,
                      3.11158, 4.497807, 3.668652, 2.267504),
                julian_day = c(41.90799, 86.61119, 92.55090, 150.67031, #mean
                               20.94627, 26.59649, 26.54255, 16.98246),#concentration
                log_mean_dist_7 = c(4.126427, 9.965601, 4.959182, 3.797415, #mean
                                    1.679125, 2.403601, 2.736004, 1.536724), #sd
                dist_start = c(0.003836731, 0.9282294, 0.9820994, 0.999999), #prob
                step_500 = c(0.002005791, 0.99999, 7.501248e-09, 1.130989e-08), #prob
                breeding_abundance = c(0.1198084, 0.4470662, 0.5400118, 0.8414759)) #prob
```
