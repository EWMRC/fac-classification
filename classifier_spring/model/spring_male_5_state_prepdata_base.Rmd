...
remove a transient summer movement which throws off the hmm for VA-2020-52-2020.
Also throw out a winter ranging movement
```{r}
...
```{r}
save.image(file=here("classifier_spring", "spring_male_data_base.RData"))
```
