...
amwo_hmm_final <- amwo_hmm_final %>%
  filter(ID != "RI-2019-21-2020", # Clip out the end of the previous fall migration
         ID != "NS-2024-35-2025", # Clip out the end of the previous fall migration
         ...
         ID != "WV-2024-47-2024", #Dispersal movement appears as a migration
         ID != "WV-2024-55-2024", #Dispersal movement appears as a migration
         ID != "WV-2025-75-2025") #Dispersal movement appears as a migration
#ID != "RI-2019-18-2020")
```
