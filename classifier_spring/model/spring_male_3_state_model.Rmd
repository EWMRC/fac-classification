...
saveRDS(amwo_hmm_final, file = here("classifier_spring", "spring_male_3_state_model.rds"))
saveRDS(results_initial$model, file = here("classifier_spring", "spring_male_3_state_parameters.rds"))
```
