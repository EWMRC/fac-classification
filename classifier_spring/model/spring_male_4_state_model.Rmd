...
dist <- list(step = "gamma", angle = "wrpcauchy", y = "norm", julian_day = "norm", log_mean_dist_7 = "norm", residence_time = "norm", dist_start = "bern", step_500 = "bern") #, lat_diff_abs = "gamma" , pts_10mi_log = "norm"
```
...
```{r}
Par0_m1 <- list(step=c(0.485, 211.927, 0.485, 0.285, #mean in km
                ...
                log_mean_dist_7 = c(log(100), log(5000), log(100), log(100), #mean
                                log(50), log(20), log(50), log(50)), #sd
                residence_time = c(40.2, 7.39, 55.9, 70.6, #mean
                                   21.6, 16.4, 32.0, 21.3), #sd
                dist_start = c(0.1, 0.9, 0.9, 0.9),
                step_500 = c(0.1, 0.9, 0.1, 0.1)) 
