...
dist <- list(step="gamma", angle="wrpcauchy", y = "norm", julian_day = "norm", log_mean_dist_7 = "norm", residence_time = "norm", dist_start = "bern", step_500 = "bern", breeding_abundance = "norm") #, lat_diff_abs = "gamma" , pts_10mi_log = "norm"
```
...
Par0_m1 <- list(step=c(0.485, 211.927, 0.485, 1, 0.285, #mean in km
                ...
                step_500 = c(0.1, 0.9, 0.1, 0.1, 0.1),
                breeding_abundance = c(0.00786, 0.0489, 0.0492, 0.0901, 0.0729,
                                       0.0421, 0.0856, 0.0792, 0.0939, 0.0859)) 
