...
nested_birds_3$data <- nested_birds_3 %>% 
  ...
  future_map(.f = function(x){
    ...
    dist_vect <- st_distance(x = x[1,], y = x, by_element = TRUE) %>% #results in meters
      as.numeric() 
...
```{r}
fixPar <- list(beta=matrix(c(NA,	-1000,	-1000,	-1000,	-1000,	NA,	NA,	NA,	-1000,	NA,	-1000,	-1000,	-1000,	-1000,	-1000,	NA,	-1000,	-1000,	-1000,	-1000), nrow = 1, byrow = TRUE)) #once entered post-migration, can't leave
```

These serve as the starting parameters for the HMM to optimize.
```{r}
Par0_m1 <- list(step=c(0.485, 211.927, 0.485, 0.485, 0.485, #mean in km
