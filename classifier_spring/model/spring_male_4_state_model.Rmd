...
nested_birds_3$data <- nested_birds_3 %>% 
  ...
  future_map(.f = function(x){
    ...
    dist_vect <- log(2, base = (dist_vect + 2)) #adding 2 so the value scales between 3.32 and 0. Form is log(x+2) 10
...
```{r}
fixPar <- list(beta=matrix(c(NA,	-1000,	-1000,	-1000,	-1000,	NA,	NA,	NA,	-1000,	NA,	-1000,	-1000,	-1000,	-1000,	-1000,	NA,	-1000,	-1000,	-1000,	NA), nrow = 1, byrow = TRUE)) #once entered post-migration, can't leave
```
