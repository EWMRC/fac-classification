...
```{r}
parameters_to_run_abv <- parameters_to_run[1:240,]
plan(multisession, workers = 8)
tbl_list <- future_pmap(.l = parameters_to_run_abv, 
                        .f = iterate_ids_male, 
...
write.table(accuracy_results_male, "variable_importance_spring_male_1_240.csv",
            append = FALSE,
            sep = ",",
            col.names = TRUE,
            row.names = FALSE,
