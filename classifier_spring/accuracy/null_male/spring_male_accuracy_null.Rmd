...
# prior_results <- read.csv("accuracy_results_male_null.csv") %>% #ensure that I'm not duplicating past labor
#   transmute(combined = paste0(cutoff_date, "_",ID))
# 
# #How many more samples do I need?
# read.csv("accuracy_results_male_null.csv") %>% 
#   pull(ID) %>% 
#   unique() %>% 
#   length()
# 
...
ggsave("spring_male_null_classification_error_DRAFT_5_22_23.png", width = 7, height = 5)
```
