...
parameters_to_run <- parameters_to_run %>% #if I omit the bird from the model, omit it from the accuracy evaluation
  filter(!(id_iter %in% c("NJ-2019-28-2020", "NS-2019-02-2020", "RI-2020-42-2021", "RI-2021-47-2022", "RI-2021-52-2022", "NY-2022-40-2022")))
...
write.table(accuracy_results_female, "accuracy_results_female.csv",
          append = TRUE,
          sep = ",",
          col.names = TRUE,
          row.names = FALSE,
...
```{r}
accuracy_results_female <- read_csv("accuracy_results_female.csv")
```
...
ggsave("spring_female_classification_error_2_22_23.png", width = 7, height = 5)
```
